...
export const MIXED_ROUTE_QUOTER_ADDRESSES = {
  ...
  [ChainId.HOLESKY]: '0x4839CFCfdF079991Ca2259ffA455f4Bfcf6FC0bD',
...
export const V3_QUOTER_ADDRESSES = {
  ...
  [ChainId.HOLESKY]: '0xDdc8dD55d3629C922b4eD505160d52401F3d3F32',
} as const satisfies Record<ChainId, Address>
...
export const V3_TICK_LENS_ADDRESSES = {
  ...
  [ChainId.HOLESKY]: '0x9CdCd598A036F120610358B16e8267B0b7227bd3',
} as const satisfies Record<ChainId, Address>
